...
console.log(twistNo)
  ...
  return (
      ...
      <br />
      <br/>
<button className="button-27"  style={{width: 150,}} onClick={handleClick}><span style={{fontSize:18}} >Generate</span></button>
...
<h1>{twisters[twistNo-1]?.content}</h1>
        
      </div>
      <div className="ribbon"><p className="text">{twisters[twistNo-1]?.content}</p></div>
    </div>
  )
}
